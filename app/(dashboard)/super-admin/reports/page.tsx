  ...
  return (
    <div className="space-y-6">
      ...
      <div className="mt-8 bg-white p-6 rounded-xl border shadow-sm">
        <h2 className="text-lg font-semibold mb-4">Ekspor Data (Excel / CSV)</h2>
        <p className="text-muted-foreground text-sm mb-6 max-w-2xl">
          Unduh seluruh data mentah pengguna ke dalam format CSV. Format ini dapat dibuka dengan Microsoft Excel, Google Sheets, atau aplikasi *spreadsheet* lainnya untuk analisa tingkat lanjut.
        </p>
        
        <div className="flex flex-col sm:flex-row gap-4">
          <Button onClick={handleDownloadCSV} loading={downloading}>
            <Download className="h-4 w-4 mr-2" />
            Unduh Data Pengguna (CSV)
          </Button>
        </div>
      </div>
    </div>
